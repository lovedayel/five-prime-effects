...
#read in M. aeruginosa 5' sequence csv and M. aeruginosa protein abundance csv

my_path = os.getcwd()

path_seq = os.path.join(my_path, "pax_db_genomes/AP009552.csv")
path_prot = os.path.join(my_path, "pax_db_proteomes/Maeruginosa_protein_abundance.csv")
...
file_object1 = open("Maeruginosa_5prot_logodds_values.csv", "w")
