...
path_seq = os.path.join(my_path, "pax_db_genomes/NC_000964.csv")
path_prot = os.path.join(my_path, "pax_db_proteomes/Bsubtilis_protein_abundance.csv")
...
file_object1 = open("Bsubtilis_5prot_logodds_values.csv", "w")
