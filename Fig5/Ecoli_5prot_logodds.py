...
#read in E. coli 5' sequence csv and E. coli protein abundance csv

path_seq = os.path.join(my_path, "pax_db_genomes/NC_000913.csv")
path_prot = os.path.join(my_path, "pax_db_proteomes/Ecoli_protein_abundance.csv")
...
file_object1 = open("Ecoli_5prot_logodds_values.csv", "w")
