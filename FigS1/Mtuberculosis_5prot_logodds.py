...
#read in B. subtilis 5' sequence csv and B. subtilis protein abundance csv

my_path = os.getcwd()

path_seq = os.path.join(my_path, "pax_db_genomes/NC_000962.csv")
path_prot = os.path.join(my_path, "pax_db_proteomes/Mtuberculosis_protein_abundance.csv")
...
file_object1 = open("Mtuberculosis_5prot_logodds_values.csv", "w")
